...
function Cursor() {
  ...
  this.drawOnCanvas = function () {
    ...
    var grdlu = ctx.createLinearGradient(
      this.x,
      view.y,
      this.x - p,
      view.y + t
    ...
    var grdru = ctx.createLinearGradient(
      this.x,
      view.y,
      this.x + p,
      view.y + t
    ...
    var grdld = ctx.createLinearGradient(
      this.x,
      view.yend,
      this.x - p,
      view.yend - t
    ...
    var grdrd = ctx.createLinearGradient(
      this.x,
      view.yend,
      this.x + p,
      view.yend - t
...
function xAx(parent) {
  ...
  this.updateDelta = function () {
    ...
    var j = -2;
    while (
      ((Math.pow(10, j) * this.deltas[i]) / sPx) * view.rx <
      cvs.width / 6
    ) {
      i++;
